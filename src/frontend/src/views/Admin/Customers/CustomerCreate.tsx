...
import { CustomerCreate as CustomerCreateSchema, CustomersService } from "../../../client"


const CustomerCreate: React.FC = () => {
  const { control, register, handleSubmit, reset } = useForm<CustomerCreateSchema>()

  const onSubmit = async (data: CustomerCreateSchema) => {
    await CustomersService.customersCreateCustomer({
      requestBody: data,
    })
  }
