  ...
  return (
    <main className={`flex-grow ${isDarkMode ? "bg-gray-900" : "bg-gray-50"}`}>
      <div className="max-w-7xl mx-auto py-6 px-5 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h2 className={`my-5 font-semibold text-2xl mb-4 ${isDarkMode ? "text-gray-200" : "text-gray-900"}`}>About</h2>
        ...
        <div className="space-y-5">
          <section>
            <h2 className={`text-xl font-semibold mb-4 ${isDarkMode ? "text-gray-200" : "text-gray-900"}`}>Our Story</h2>
          ...
          <section>
            <h2 className={`text-xl font-semibold mb-4 ${isDarkMode ? "text-gray-200" : "text-gray-900"}`}>Our Craft</h2>
            <p className={`leading-relaxed ${isDarkMode ? "text-gray-300" : "text-gray-800"}`}>
            ...
            <p className={`mt-2 leading-relaxed ${isDarkMode ? "text-gray-300" : "text-gray-800"}`}>
